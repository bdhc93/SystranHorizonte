...
namespace SystranHorizonte.Web.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 18, nameOption = "Listar Estaciones", controller = "Estacion", action = "ListarEstacion", status = true, isParent = false, parentId = 11 });
            menu.Add(new Navbar { Id = 19, nameOption = "Nueva Estacion", controller = "Estacion", action = "AgregarEstacion", status = true, isParent = false, parentId = 11 });
            menu.Add(new Navbar { Id = 20, nameOption = "Listar Horarios", controller = "Horario", action = "ListHorarios", status = true, isParent = false, parentId = 11 });
            menu.Add(new Navbar { Id = 21, nameOption = "Nuevo Horario", controller = "Horario", action = "AddHorario", status = true, isParent = false, parentId = 11 });
            menu.Add(new Navbar { Id = 22, nameOption = "Listar Vehículos", controller = "Vehiculo", action = "ListarVehiculo", status = true, isParent = false, parentId = 11 });
            menu.Add(new Navbar { Id = 23, nameOption = "Nuevo Vehículos", controller = "Vehiculo", action = "AgregarVehiculo", status = true, isParent = false, parentId = 11 });
            menu.Add(new Navbar { Id = 24, nameOption = "La Empresa", imageClass = "fa fa-hospital-o", status = true, isParent = true, parentId = 0 });
            menu.Add(new Navbar { Id = 25, nameOption = "Quienes Somos", controller = "Home", action = "Forms", status = true, isParent = false, parentId = 24 });
            menu.Add(new Navbar { Id = 26, nameOption = "Contatos", controller = "Home", action = "Forms", status = true, isParent = false, parentId = 24 });
