...
namespace SystranHorizonte.Web.Domain
{
    public class Data
    {
        ...
        public IEnumerable<Navbar> navbarItemsvendedor()
        {
            var menu = new List<Navbar>();
            menu.Add(new Navbar { Id = 1, nameOption = "Inicio", controller = "Home", action = "Index", imageClass = "fa fa-share-square-o", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 2, nameOption = "Ventas", imageClass = "fa fa-shopping-cart", status = true, isParent = true, parentId = 0 });
        ...
        public IEnumerable<Navbar> navbarItemspublic()
        {
            var menu = new List<Navbar>();
            menu.Add(new Navbar { Id = 1, nameOption = "Inicio", controller = "Home", action = "Index", imageClass = "fa fa-share-square-o", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 2, nameOption = "La Empresa", imageClass = "fa fa-hospital-o", status = true, isParent = true, parentId = 0 });
            menu.Add(new Navbar { Id = 3, nameOption = "Quienes Somos", controller = "Home", action = "Forms", status = true, isParent = false, parentId = 2 });
            menu.Add(new Navbar { Id = 4, nameOption = "Contatos", controller = "Home", action = "Forms", status = true, isParent = false, parentId = 2 });
